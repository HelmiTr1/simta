      ...
      <div class="card">
        <div class="card-header border-0 mb-0">
          <div class="row align-items-center">
            <div class="col">
              <h3 class="mb-0">Tambah Data Menu</h3>
            </div>
          </div>
        </div>
        <hr class="my-0">
        ...
        <form method="POST" action="{{url('menu')}}">
            @csrf
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                  <input type="text" class="form-control @error('menu') is-invalid @enderror" name="menu" id="inputmenu3" placeholder="Menu" value="{{old('menu')}}">
                    @error('menu')
                ...
                <div class="form-group row text-right">
                  ...
                  <a href="{{url('menu')}}" class="btn btn-danger" id="btn-cancel">Cancel</a>
                  </div>
                </div>
              </form>
        </div>
