    ...
    public function Crossover()
    {
        ...
        for ($i = 0; $i < $this->populasi; $i += 2)
        {
            ...
            if (floatval($cr) < floatval($this->crossover)) {
                $a = mt_rand(0, $mhs_count - 2);
                while ($b <= $a) {
                    $b = mt_rand(0, $mhs_count - 1);
                }
                for ($j = 0; $j < $a; $j++) {
                    for ($k = 0; $k < 4; $k++) {                        
